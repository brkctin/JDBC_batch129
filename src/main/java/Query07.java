...
public class Query07 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
            ...
            //SORU 1: Urunler adında bir tablo olusturalım (id int, isim varchar(10), fiyat int)
            ...
            kayitlar.add(new Urun(104, "Klavye",15000));
            kayitlar.add(new Urun(105, "IMac",45000));

            //Çok miktarda data eklemek icin PreparedStatment kullanmalıyız.
            ...
            for(Urun each:kayitlar){
                ...
                tablo.addBatch();                                   //Bütün data'ları birleştiriyor
            }
            tablo.executeBatch();
